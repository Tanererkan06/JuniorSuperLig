...
function UpdateSponsor(props) {
    ...
    const [sponsorIl, setSponsorIl] = useState("");
    ...
    useEffect(() => {
        SponsorService.getById(id).then(response => {
            ...
            setSponsorIl(response.data.sponsoril);
    ...
    const updateSponsorFunc = () => {
      ...
      // {
        ...
        const data = {sponsoradi: sponsorAdi, sponsoril: sponsorIl, sponsorkategori: sponsorKategori, sponsorreklami: sponsorReklami, sponsorluksuresi: sponsorlukSuresi, sponsorluksureturu: sponsorlukSureTuru, sponsorlukucreti: sponsorlukUcreti, sponsorlukucretbirimi: sponsorlukUcretBirimi, published}
          dispatch(updateSponsor({id: props.id, data}));
          notify();
          setTimeout(() => {
            props.close();
    ...
    <>
        <form className="formcss">
            ...
            <div className="col-xs-12" style={{ marginLeft: '-30px' }}>
              ...
              <div className="col-xs-4">
                <label className="labelcss" htmlFor="sponsorIl">Sponsor Il</label>
                <input className="inputcss"  type="text" placeholder="Sponsor il" value={sponsorIl} name="sponsorIl" onChange={(event) => { setSponsorIl(event.target.value); }} />
              </div>
              <div className="col-xs-4">

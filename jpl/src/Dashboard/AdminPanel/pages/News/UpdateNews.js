...
function UpdateNews(props) {
    ...
    useEffect(() => {
          NewsService.getById(id).then(response => {
            ...
            setDesc(response.data.desc.replaceAll('&lt;','<'));
    ...
    const updateNewsFunc = () => {
          ...
          const data = {baslik, icerik, resim, kisaicerik: kisaIcerik, tarih, ulke, sehir, lig, takimid: takimId, desc, published};
          dispatch(updateNews({id: props.id, data}));
          notify();
          setTimeout(() => {
            props.close();
    ...
    <>
        ...
        <div className="col-xs-12">
         ...
         <div className="col-xs-12">
            ...
            <div className='col-xs-3'>
              <label className="labelcss" htmlFor='desc'>Description </label>

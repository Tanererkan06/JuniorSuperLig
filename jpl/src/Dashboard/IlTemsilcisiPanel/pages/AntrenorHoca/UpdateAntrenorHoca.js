...
// const Takim =  io.connect("http://localhost:3001/Takim");
...
function UpdateAntrenorHoca(props) {
    ...
    const updateAntrenorHocaFunc = () => {
          ...
          const data = {adi, soyadi, telefon, adres, uyruk, resim, dogumyeri: dogumYeri, dogumtarihi: dogumTarihi, takimid: takimId, takimadi: takimAdi, published};
          dispatch(updateAntrenorHoca({id: props.id, data}));
          notify();
          setTimeout(() => {
            props.close();

...
import { getAllGozlemci, getAllPublishedGozlemci, deleteGozlemci, deleteAllGozlemci } from '../../../../redux-new/actions/gozlemci';
...
export default function DashboardGetAllGozlemci() {
    ...
    //     console.log("GOZLEMCI RESP DATA: ", response.data);
                ...
                <div className="listele-display-table">
                    <div className="listele-width-95">
                        <table className="listele-table">
                            ...
                            {
                                gozlemci.length > 0
                                ? gozlemci.map((item, index) => {
                                    // console.log("verı: ", gozlemci);
                                    return (
                                        <tr>
                                            {/* <td>
                                                <DropdownList

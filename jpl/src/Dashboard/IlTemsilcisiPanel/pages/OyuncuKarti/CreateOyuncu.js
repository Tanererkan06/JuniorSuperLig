  ...
  const notify = () => toast.success('Oyuncu eklendi!', {
    ...
    const createOyuncuKartiFunc = () => {
      if(show === false) {
        ...
        const data = {kimlikNo, adi, soyadi, dogumYeri, dogumTarihi, boy, kilo, pozisyon, takimId, takimAdi, lig, formaNo, oynadigiMacSayisi, atilanGolSayisi, asist, resim, oncekiTakimi, sariKart, kirmiziKart, hocaId, hocaAdi, veli, telefon, adres, uyruk, published}

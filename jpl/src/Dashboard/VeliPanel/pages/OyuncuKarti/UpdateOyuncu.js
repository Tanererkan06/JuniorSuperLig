...
function UpdateOyuncuKarti(props) {
    ...
    const updateOyuncuKartiFunc = () => {
      // if(adi.length > 0 && soyadi.length > 0 && dogumYeri.length > 0 && dogumTarihi.toString().length > 0 > 0 && boy.length > 0 && kilo.length > 0 && pozisyon.length > 0 && takimId.length > 0 && takimAdi.length > 0 && formaNo.length > 0 && oynadigiMacSayisi.length > 0 && atilanGolSayisi.length > 0 && asist.length > 0 && oncekiTakimi.length > 0 && sariKart.length > 0 && kirmiziKart.length > 0 && hocaId.length > 0 && hocaAdi.length > 0 && veli.length > 0 && adres.length > 0 && eposta.length > 0 && uyruk.length > 0)
      //   {

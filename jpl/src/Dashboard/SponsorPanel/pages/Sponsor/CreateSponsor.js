  ...
  const notify = () => toast.success('Sponsor eklendi!', {
    ...
    const createSponsorFunc = () => {
        ...
        // {
          ...
          // const data = {sponsorAdi, sponsorIl, sponsorKategori, sponsorReklami, sponsorlukSuresi, sponsorlukSureTuru, sponsorlukUcreti, sponsorlukUcretBirimi, published }
          const data = {sponsorAdi, sponsorIl, sponsorKategori, sponsorReklami, sponsorlukSuresi, sponsorlukSureTuru, published }
        ...
        <form className="formcss">
            ...
            <div className="col-xs-12" style={{ marginLeft: '-30px' }}>
              ...
              <div className="col-xs-4">
                ...
                <input className="inputcss"  type="text" placeholder="Sponsor il" name="sponsorIl" onChange={(event) => { setSponsorIl(event.target.value); }} />
              </div>
              <div className="col-xs-4">

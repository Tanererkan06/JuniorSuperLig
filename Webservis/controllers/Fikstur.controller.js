...
exports.create = (req, res) => { 
 ...
 /*  if (!req.body) {
  ...
  let fikstur = new Fikstur({
    ...
    başlangıctarihi:req.body.başlangıctarihi,
    bitistarihi:req.body.bitistarihi,
    mactarihi:req.body.mactarihi,
    evsahibitakmid:req.body.evsahibitakmid,
    deplasmantakimid:req.body.deplasmantakimid,
    evsahibitakimadi:req.body.evsahibitakimadi,
    deplasmantakimadi:req.body.deplasmantakimadi,
    oyunyeri:req.body.oyunyeri,

...
function UpdateTakim(props) {
    ...
    const updateTakimFunc = () => {
      ...
      //   {
        // const data = {adi, kurulustarihi: kurulusTarihi, telefon, adres, oyunKonum, fax, website, oyuncular, hocaId, hocaAdi, logo, konum, sorumlu, sorumluIletisim, eposta, sifre, published}
        const data = { adi, kurulustarihi: kurulusTarihi, telefon, adres, oyunKonum, fax, website, hocaId: currentUser.id, logo, konum, lig, eposta: currentUser.email, sehir,  published: true }
        ...
        <form className="formcss">
              ...
              <div className="col-xs-12" >
                <div className="col-xs-3">
                  <label className="labelcss" htmlFor="adi">Takım Adı</label>
                ...
                <div className="col-xs-3">
                  ...
                  <input className="inputcss" type="text" placeholder="Adres" value={adres} name="adres" onChange={(event) => { setAdres(event.target.value); }} />
                </div>
              </div>
              <div className="col-xs-12" >
                ...
                <div className="col-xs-4">
                  ...
                  <input className="inputcss" type="text" placeholder="Website" value={website} name="website" onChange={(event) => { setWebsite(event.target.value); }} />
                </div>
                {/* <div className="col-xs-3">

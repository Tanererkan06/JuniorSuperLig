...
function CreateTakim(props) {
  ...
  // console.log("HOCA DETAY: ", currentUser);
  ...
  const notify = () => toast.success('Takim eklendi!', {
    ...
    const createTakimFunc = () => {
          ...
          const data = { adi, kurulusTarihi, telefon, adres, oyunKonum, fax, website, hocaId: currentUser.id, logo, konum, lig, eposta: currentUser.email, sehir,  published: true }
        ...
        <form className="formcss">
              ...
              <div className="col-xs-12" >
                ...
                <div className="col-xs-4">
                  ...
                  <input className="inputcss" type="text" placeholder="Şehir" name="sehir" value={sehir} disabled />
                </div>
              </div>
              <div>

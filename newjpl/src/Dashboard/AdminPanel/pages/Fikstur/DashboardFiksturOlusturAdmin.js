  ...
  return (
    <div className='dashboard-container'>
      ...
      <Form className="mx-auto" style={{ width: "50%", }}  >
        ...
        <Form.Group className="mb-3">
            <Form.Label>Takımlar</Form.Label>
            <Multiselect
              data={takimVerileri}
              dataKey="id"
              textField="name"
        ...
        <Form.Group className="mb-3">
            <Form.Label>Eşleşme Türü</Form.Label>
            <DropdownList
                data={fiksturTuru}
                dataKey='id'
                textField='name'
        ...
        <Form.Group className="mb-3">
            <Form.Label>Lig Başlangıç Tarihi</Form.Label>
            <Form.Control
                type="date"
                name="baslangic"
        ...
        <Form.Group className="mb-3">
            <Form.Label>Lig Bitiş Tarihi</Form.Label>
            <Form.Control
                type="date"
                name="baslangic"
        ...
        <Form.Group>
            <Button className="mb-3" onClick={(e) => saveFikstur(e)} type="submit">Oluştur</Button>
        </Form.Group>
          </Form>
      </div>
    </div>

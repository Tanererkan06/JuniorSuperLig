...
const Signup = () => {
    ...
    const sehirFunction = (value) => {
        // console.log("sehiradi: ", value.sehiradi);
                ...
                {!successful && (
                    <div>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            />
                            <Form.Control.Feedback>İyi görünüyor!</Form.Control.Feedback>
                            {/* <button className="buttoncss-signup-dogrula" onClick={() => checkOTP(otp)}>Doğrula</button> */}
                            {/* <button className="buttoncss-signup-dogrula" >Doğrula</button> */}
                        </Form.Group>

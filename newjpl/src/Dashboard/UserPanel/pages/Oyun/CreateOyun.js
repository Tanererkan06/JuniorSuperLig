  ...
  const [gozlemciData, setGozlemciData] = useState([]);
    ...
    const createOyunFunc = () => {
      ...
      if(takimBirAdi != takimIkiAdi)
      {
        ...
        const data = { adi, macTarihi, macSaati, lig, sehir, yer, takimBirId, takimBirAdi, takimIkiId, takimIkiAdi, gozlemciId, gozlemciAdi, yorum, macSonu, ilkYariSonucu, published }

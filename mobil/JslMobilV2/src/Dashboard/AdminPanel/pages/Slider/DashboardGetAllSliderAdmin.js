        ...
        <div className='dashboard-container'>
            ...
            <div className='dashboard-body'>
                <div>
                    ...
                    >
                        <h2 ref={(_subtitle) => (subtitle = _subtitle)}>Yeni Sponsor Resim Ekle</h2>
                ...
                <div>
                    <Modal
                        ...
                        contentLabel="Example Modal"
                    >
                        <h2 ref={(_subtitle) => (subtitle = _subtitle)}>Sponsor Resimi Düzenle</h2>
                ...
                {/* <div className="listele-display-table">
                    <div className="listele-width-95">
                        <table className="listele-table">
                            ...
                            {
                                slider.length > 0
                                ? slider.filter(item => item.sehir === currentUser.sehir).map((item, index) => {

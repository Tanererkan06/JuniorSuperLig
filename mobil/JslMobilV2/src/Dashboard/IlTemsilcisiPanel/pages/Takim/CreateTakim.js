...
function CreateTakim(props) {
  ...
  const notify = () => toast.success('Takim eklendi!', {
    ...
    const createTakimFunc = () => {
          // const data = { adi, kurulusTarihi, telefon, adres, oyunKonum, fax, website, oyuncular, hocaId, hocaAdi, logo, konum, sorumlu, sorumluIletisim, lig, sehir, eposta, sifre, published }
          const data = { adi, kurulusTarihi, telefon, adres, oyunKonum, fax, website, oyuncular, hocaId, hocaAdi, logo, konum, sorumlu, sorumluIletisim, lig, sehir, published }
        ...
        <form className="formcss">
              ...
              <div className="col-xs-12" style={{ marginLeft: '-30px' }}>
                ...
                <div className="col-xs-3">
                  ...
                  <input className="inputcss" type="file" placeholder="Logo" name="logo" required accept="image/*" onChange={(event) => { setLogo(event.target.value); }} />
                </div>
                <div className="col-xs-3">
              ...
              <div className='div2'>
                ...
                <div>
                  <label className="labelcss" htmlFor="lig">Şehir</label>
